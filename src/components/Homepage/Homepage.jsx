  ...
  return (
    <div className='intropage'>
      ...
      <div className='display-text'>
        <h2 id='welcome-typing' className='welcome'>Hello I'm James.</h2><h2 className='underline'> _</h2>
      </div>
      
      <div className='scroll-down'>Scroll down to view profile<ChevronDoubleDownIcon className='scroll-down-icon'/></div>
